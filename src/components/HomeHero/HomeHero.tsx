    ...
    return (
        <Layout>
            <div
                className={'w-full'}
                style={{
                    background: 'radial-gradient(113.04% 76.15% at 0% 0%, rgba(255, 255, 255, 0.2) 0%, rgba(255, 255, 255, 0) 100% ), #000'
                }}>
                <div
                    className='-mt-[72px] overflow-hidden w-full relative max-w-[1440px] mx-auto'
                ...
                >
                    ...
                    <div
                        ...
                        <div
                            className='max-w-[577px] w-full relative mx-auto p-2 gradient-border mt-[100px] before:rounded-2xl xmd:mt-[120px]'>
                            <div
